...
@endsection
@section('titulopagina','Conductores MOBILIZE')
@section('migajas')
<div class="breadcrumb-wrapper mr-1">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Conductores MOBILIZE
        </li>
    </ol>
</div>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">En está sección se muentras los Conductores que tiene el sistema de MOBILIZE</h4>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table center table-striped table-bordered text-inputs-searching">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   <td class="text-center"><a style="color:blue;" href="#">Joel</a> </td>
                                ...
                                <tr>
                                   <td class="text-center"><a style="color:blue;" href="#">David</a> </td>
